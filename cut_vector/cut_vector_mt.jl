...
X, Y = make_rows(
    ...
    [listinteger_caster],
    ["output1", "output2"],
    [listinteger_caster, listinteger_caster],
    extra_inputs,
    "train_data"
)
...
# Libraries
bs = [listinteger_bundles, integer_bundles]
lib_any = Library(reduce(vcat, bs))

# Libraries
lib_any = Library([listinteger_bundles..., integer_bundles...])
