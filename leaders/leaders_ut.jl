...
N_TRAIN = 200 # MODIF
N_TEST = 2000 # MODIF
PROBLEM = "leaders" # MODIF
EXPERIMENT_NAME = "Leaders" # MODIF
STAGE = 1
MODE = "UT" # MODIF 
N_types = 2 # MODIF
endpoint = EndpointBatchVecDiff # MODIF
...
#     is_m = evalfn(lib_listinteger[:is_more_eq_than_right], [x[1]])
#     # subset
#     pred = evalfn(lib_listinteger[:subset_by_mask], [x[1], is_m])

#     # Endpoint
#     return EndpointBatchVecDiff([[pred]], y)
# end
# losses = []
# for (x, y) in zip(X_test, Y_test)
#     loss = algo_leaders(x, y)
#     push!(losses, loss)
# end
