...
extra_inputs = [0, 1, -1, 0.0, 1.0, -1.0]
# TRAIN DATA --- ---- 
X, Y = make_rows(
    ["input1", "input2", "input3", "input4"],
    [integer_caster, float_caster, float_caster, float_caster],
    ["output1"],
    [float_caster],
    extra_inputs,
    "train_data"
...
lib_listfloat = Library(listfloat_bundles)

# MetaLibrary
ml = MetaLibrary([lib_float, lib_listfloat])

### Model Architecture ###
model_arch = modelArchitecture(
    [Int, Float64, Float64, Float64, Int, Int, Int, Float64, Float64, Float64],
    [3, 1, 1, 1, 3, 3, 3, 1, 1, 1],
